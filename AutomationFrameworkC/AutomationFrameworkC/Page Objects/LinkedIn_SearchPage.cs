...
namespace AutomationFrameworkC.Page_Objects
{
    class clsLinkedIn_SearchPage : BaseTest
    {
        ...
        private static LinkedIn_LoginPage objLogin; 
        #endregion variables
        #region Constructor
        ...
        public static void fnClickPeopleBtn()
        {
            ...
            {
                Console.WriteLine("The Element People button doesnt exist: " + e.Message);
                Assert.Fail();
            }
        }
        ...
        public static void fnClickAllFiltersBtn()
        {
            ...
            {
                Console.WriteLine("The Element All Filters Button doesnt exist: " + e.Message);
                Assert.Fail();
            }
        }
        ...
        public static void fnAddCountryRegion(List<string> plistcountries)
        {
            ...
            {
                Console.WriteLine("The Element Add a country doesnt exist: " + e.Message);
                Assert.Fail();
            }
        }
        ...
        public static void fnClickApplyFilters()
        {
            ...
            {
                Console.WriteLine("The Element Apply Filters doesnt exist: " + e.Message);
                Assert.Fail();
            }
        }
