...
namespace AutomationFrameworkC.Page_Objects
{
    class clsPHPTravels_LoginPage : BaseTest
    {
        ...
        /*OBJECT DEFINITION*/
        //LOGIN
        private static readonly IWebElement objEmailTxt = objDriver.FindElement(By.Name(STR_EMAIL_TXT));
        private static readonly IWebElement objPasswordTxt = objDriver.FindElement(By.Name(STR_PASSWORD_TXT));
        private static readonly IWebElement objRememberMeLnk = objDriver.FindElement(By.XPath(STRREMEMBERME_LNK));
        private static readonly IWebElement objForgotPassLnk = objDriver.FindElement(By.XPath(STR_FORGOTPASS_LNK));
        private static readonly IWebElement objLoginBtn = objDriver.FindElement(By.XPath(STR_LOGIN_BTN));
        ...
        public static void fnMenuDisp(String submenu, String title)
        {
            ...
            fnSort("//th[@data-orderby='pt_accounts.ai_first_name']");
            _driverWait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.ClassName("xcrud-overlay")));
            fnSort("//th[@data-orderby='pt_accounts.ai_last_name']");
            _driverWait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.ClassName("xcrud-overlay")));
            fnSort("//th[@data-orderby='pt_accounts.accounts_email']");
            _driverWait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.ClassName("xcrud-overlay")));
            fnSort("//th[@data-orderby='pt_accounts.accounts_status']");
            _driverWait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.ClassName("xcrud-overlay")));
            fnSort("//th[@data-orderby='pt_accounts.accounts_last_login']");
        }
